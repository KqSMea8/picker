...
for row in c.execute('select company_name,  round(total_debt / total_assets, 2) debt_ratio, '
  ...
  + 'from stocks where pb_ratio < 1.2 and pe_ratio < 9 and debt_ratio < 0.5 and current_ratio > 1.5 '
  + 'and roe1 > 0.08 and roe2 > 0.08 and roe3 > 0.08 and roe4 > 0.08 and debt_to_liq_ratio < 1.1 '
  + 'and dividend_yield > 1.0 order by debt_ratio'):
